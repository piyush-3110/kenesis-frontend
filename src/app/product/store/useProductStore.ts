...
export const useProductLoading = () =>
  useProductStore((state) => state.loading);
export const useProductError = () => useProductStore((state) => state.error);
export const useProductReviews = () =>
  useProductStore((state) => state.reviews);
export const useSelectedContent = () =>
  useProductStore((state) => state.selectedContent);
export const useContentProgress = () =>
  useProductStore((state) => state.contentProgress);
export const useCompletedContent = () =>
  useProductStore((state) => state.completedContent);
