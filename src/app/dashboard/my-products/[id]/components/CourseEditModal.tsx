...
const CourseEditModal: React.FC<CourseEditModalProps> = ({ 
  ...
  // Memoize individual input handlers to prevent re-renders
  const handleTitleChange = useMemo(() => handleInputChange('title'), [handleInputChange]);
  const handleShortDescriptionChange = useMemo(() => handleInputChange('shortDescription'), [handleInputChange]);
  const handleDescriptionChange = useMemo(() => handleInputChange('description'), [handleInputChange]);
  const handleLevelChange = useMemo(() => handleInputChange('level'), [handleInputChange]);
  const handleLanguageChange = useMemo(() => handleInputChange('language'), [handleInputChange]);
  const handlePriceChange = useMemo(() => handleInputChange('price'), [handleInputChange]);
