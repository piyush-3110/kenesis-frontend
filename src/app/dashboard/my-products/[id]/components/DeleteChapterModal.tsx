      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-white">Delete Chapter</h2>
              <p className="text-sm text-gray-400">Confirm chapter deletion</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6">
          <div className="mb-4">
            ...
            <div className="p-3 bg-gray-800 rounded-lg">
              <p className="text-gray-300 font-medium">{chapter.title}</p>
            </div>
          </div>
          ...
          {hasModules ? (
            <div className="mb-6 p-4 bg-red-500/10 border border-red-500/20 rounded-lg">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-red-400 font-medium mb-1">Warning: Chapter Contains Modules</h4>
