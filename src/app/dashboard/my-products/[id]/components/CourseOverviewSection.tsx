...
import { formatTokenString } from "@/lib/utils/tokenDisplay";
import { BookOpen, Calendar, Clock, DollarSign, Globe, Star, Users } from "lucide-react";
 ...
 */
const CourseOverviewSection: React.FC<CourseOverviewSectionProps> = ({ course, canEdit, chapters }) => {
        ...
        if (course.chapters && Array.isArray(course.chapters)) {
            ...
            const totalSeconds = course.chapters.reduce((total: number, chapter: any) => {
                if (chapter.modules && Array.isArray(chapter.modules)) {
                    return (
                        total +
                        chapter.modules.reduce((chapterTotal: number, module: any) => {
    ...
    return (
        <div className="space-y-8 h-full flex flex-col">
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-white text-lg font-semibold">{formatDuration(totalDuration)}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-white text-lg font-semibold">
                                    {totalChapters} chapters, {totalModules} modules
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div
                className="h-px w-full flex-shrink-0"
                style={{
                    background: "linear-gradient(90deg, transparent 0%, rgba(6, 128, 255, 0.2) 50%, transparent 100%)",
                }}
            />
                    ...
                    >
                        ...
                        <div className="space-y-4 flex-1 overflow-y-auto">
                            ...
                            {course.metadata?.learningOutcomes && course.metadata.learningOutcomes.length > 0 && (
                                <div>
                                    <h4 className="text-lg text-gray-300 mb-2">Learning Outcomes</h4>
                                    <ul className="space-y-1">
                        ...
                        <div className="space-y-4 flex-1 overflow-y-auto">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-white truncate">{formatDate(course.createdAt)}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-white truncate">{formatDate(course.updatedAt)}</p>
                                </div>
                            </div>
                            ...
                            {course.publishedAt && (
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-white truncate">{formatDate(course.publishedAt)}</p>
                                    </div>
                                </div>
                            )}
                            ...
                            {course.affiliatePercentage > 0 && (
                                <div className="mt-2">
                                    <p className="text-gray-400 text-sm">
                                        ...
                                        <span className="text-white">{course.affiliatePercentage / 100}%</span>
                                    </p>
                                </div>
                            )}
                        </div>
                                ...
                                {course.status === "submitted" && (
                                    <div className="p-3 bg-yellow-500/10 rounded-xl">
                                        <p className="text-yellow-400 text-sm">
                                            This course is under review. You&apos;ll be notified once the review is
                                            complete.
                                        </p>
                                    </div>
                                )}
