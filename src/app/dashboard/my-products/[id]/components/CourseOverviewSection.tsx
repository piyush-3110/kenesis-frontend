        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4 min-w-0">
            <div>
              ...
              <p className="text-gray-300 leading-relaxed line-clamp-3">{course.description || 'No description available'}</p>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          <div 
            ...
            style={{
              background: 'linear-gradient(135deg, rgba(6, 128, 255, 0.1) 0%, rgba(30, 58, 138, 0.05) 100%)',
            }}
          >
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-white text-lg font-semibold">
                  {course.chapters?.length || 0} chapters, {course.stats?.moduleCount || 0} modules
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="mt-2">
                ...
                <div className="flex flex-wrap gap-1 mt-1">
                  {course.tokenToPayWith.map((token: string) => (
                    <span key={token} className="px-2 py-1 bg-gray-700/50 text-gray-300 text-xs rounded-lg">
                      {token}
                    </span>
                  ))}
                </div>
