          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <GradientBox>
              <div className="p-4 text-center">
                ...
                <p className="text-2xl font-bold text-white">{stats.draftProducts}</p>
            ...
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2 bg-gray-800/50 border border-gray-700/50 rounded-lg text-white text-sm focus:outline-none focus:border-blue-500/50 transition-colors min-w-[200px]"
                />
              </div>
              ...
              <select
                ...
                className="px-3 py-2 bg-gray-800/50 border border-gray-700/50 rounded-lg text-white text-sm focus:outline-none focus:border-blue-500/50 transition-colors"
              >
              ...
              <button 
                ...
                className="px-3 py-2 bg-gray-800/50 border border-gray-700/50 rounded-lg text-gray-300 hover:text-white transition-colors text-sm"
              >
                Reset
              </button>
          ...
          {filteredProducts.length > 0 ? (
            ...
            <GradientBox>
              <div className="text-center py-12">
                ...
                {searchQuery || statusFilter !== 'all' || typeFilter !== 'all' || categoryFilter ? (
                  <>
