...
const ModuleCard: React.FC<{
  ...
  canEdit: boolean;
  onDelete: () => void;
}> = ({ module, courseId, chapterId, canEdit, onDelete }) => {
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex items-center justify-between border-b border-gray-700 pb-3">
                ...
                <span className="text-xs text-gray-400">
                  Last updated:{" "}
                  {moduleContent.updatedAt
                    ? new Date(moduleContent.updatedAt).toLocaleDateString()
                    : "Unknown"}
                </span>
              </div>
                          ...
                          <div className="flex items-center gap-3 text-xs text-gray-400">
                            ...
                            {moduleContent.duration && (
                              <>
                                <span>•</span>
                                <span>
                                  {formatDuration(moduleContent.duration)}
                                </span>
                              </>
                            )}
                          </div>
                        ...
                        <div>
                          ...
                          <p
                            className={`font-medium ${
                              moduleContent.metadata.hasAccess
                                ? "text-green-400"
                                : "text-red-400"
                            }`}
                          >
