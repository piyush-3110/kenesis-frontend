...
export const updateUserProfile = async (data: UpdateProfileRequest): Promise<UpdateProfileResponse> => {
  try {
    const response = await http.put<ApiEnvelope<UpdateProfileResponse>>('/api/users/profile', data, {
      headers: {
 ...
 */
export const updateSocialMediaLinks = async (data: UpdateSocialMediaRequest): Promise<UpdateProfileResponse> => {
  try {
    const response = await http.put<ApiEnvelope<UpdateProfileResponse>>('/api/users/profile', data, {
      headers: {
        'Content-Type': 'application/json',
    ...
    if (!response.data.success) {
      throw new Error(response.data.message || 'Failed to update social media links');
    }
 ...
 */
export const updateUserProfileWithFile = async (data: UpdateProfileWithFileRequest): Promise<UpdateProfileResponse> => {
  try {
    ...
    const response = await http.put<ApiEnvelope<UpdateProfileResponse>>('/api/users/profile', formData, {
      headers: {
...
export const requestPasswordReset = async (email: string): Promise<void> => {
  try {
    const response = await http.post<ApiEnvelope<null>>('/api/auth/forgot-password', {
      email,
    });
...
export const resetPassword = async (token: string, newPassword: string): Promise<void> => {
  try {
    const response = await http.post<ApiEnvelope<null>>('/api/auth/reset-password', {
      token,
      newPassword,
    });
