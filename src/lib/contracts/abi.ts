...
export const KENESIS_MARKETPLACE_ABI = [
    {
        inputs: [
            ...
            { internalType: "uint256", name: "_marketplaceFeePercent", type: "uint256" },
    ...
    { inputs: [], name: "ParameterMismatch", type: "error" },
    ...
    {
        anonymous: false,
        inputs: [{ indexed: true, internalType: "address", name: "newSigner", type: "address" }],
    ...
    },
    {
        ...
        inputs: [
            ...
            { indexed: false, internalType: "uint256", name: "priceInUSD", type: "uint256" },
            { indexed: false, internalType: "address", name: "paymentToken", type: "address" },
            { indexed: false, internalType: "address", name: "affiliateAddress", type: "address" },
            { indexed: false, internalType: "uint256", name: "affiliateCommission", type: "uint256" },
        ],
    ...
    },
    {
        ...
        outputs: [{ internalType: "contract IKenesisNFT", name: "", type: "address" }],
        stateMutability: "view",
        type: "function",
    },
    {
...
export type ContractErrorType = (typeof CONTRACT_ERRORS)[keyof typeof CONTRACT_ERRORS];
