...
import { Star, PlayCircle, FileText, CheckCircle, ShoppingCart, Lock, Eye } from 'lucide-react';
      ...
      return (
        <div className="mt-2 sm:mt-3">
          <div className="flex items-center gap-2 px-3 py-2 bg-green-600/20 border border-green-500/50 rounded-lg">
            ...
            <span className="text-green-400 text-sm font-medium">Access Content</span>
          </div>
      ...
      >
        <div 
          className={`w-full h-full rounded-lg p-3 sm:p-4 ${
            isPurchased ? 'bg-gradient-to-br from-green-900/20 to-black' : 'bg-gradient-to-br from-gray-900 to-black'
          }`}
          style={{
            background: isPurchased 
        ...
        >
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            ...
            <div className="relative w-full sm:w-24 md:w-32 h-40 sm:h-24 md:h-32 flex-shrink-0">
              <Image
                ...
                className={`object-cover rounded-lg transition-transform duration-300 group-hover:scale-105 ${
                  !isPurchased && accessLevel === 'none' ? 'grayscale opacity-60' : ''
                }`}
            ...
            <div className="flex-1 min-w-0 flex flex-col justify-between">
              <div>
                {/* Title */}
                <h3 className={`font-semibold text-base sm:text-lg line-clamp-2 mb-2 group-hover:text-blue-300 transition-colors ${
