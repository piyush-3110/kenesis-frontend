        ...
        <div className="p-0 h-full flex flex-col">
          ...
          <div className="relative h-48 rounded-t-lg overflow-hidden">
            ...
            <div className="absolute top-3 right-3">
              {product.status === 'published' ? (
                ...
                <div className="flex items-center gap-1 px-2 py-1 rounded-md bg-yellow-500/20 text-yellow-400 text-xs font-medium border border-yellow-500/30">
                  <EyeOff size={12} />
                  <span>Submitted</span>
                </div>
              ) : (
          ...
          <div className="p-4 flex-1 flex flex-col">
            ...
            <div className="flex items-center justify-between gap-2 mb-2">
              <span className="text-blue-400 text-xs font-medium uppercase tracking-wide truncate min-w-0 flex-1">
                {product.category}
              </span>
              <span
                className={cn(
                  "px-2 py-1 rounded text-xs font-medium border flex-shrink-0 whitespace-nowrap",
            ...
            <div className="flex items-center justify-between gap-3 mt-auto">
              ...
              <Link
                ...
                className="px-3 py-1.5 rounded-md bg-blue-500 text-white text-sm font-medium hover:bg-blue-600 transition-colors flex-shrink-0 whitespace-nowrap"
              >
                Manage
              </Link>
            </div>
