...
interface ModuleCreationModalProps {
  ...
  loading?: boolean;
  editingModule?: ModuleFormData & { id?: string };
  isEditing?: boolean;
}
  ...
  const validateForm = (): boolean => {
    ...
    if (formData.mainFile) {
      ...
      if (!allowedTypes.includes(formData.mainFile.type)) {
        newErrors.mainFile = 'Please select a valid file (MP4, WebM, OGG, PDF, DOC, DOCX)';
      }
    } else if (!isEditing) {
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                {errors.chapterId && <p className="mt-1 text-red-400 text-sm">{errors.chapterId}</p>}
              </div>
              ...
              <div>
                ...
                <div className="flex justify-between mt-1">
                  <span className="text-xs text-gray-500">3-200 characters required</span>
              ...
              <div>
                ...
                />
                <div className="flex justify-between mt-1">
                  <span className="text-xs text-gray-500">Optional - describe what this module covers</span>
                  <span className="text-xs text-gray-500">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-white">Module Settings</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  ...
                  <input
                    ...
                    disabled={isSubmitting || loading}
                  />
                  <p className="text-xs text-gray-500 mt-1">Leave empty for automatic ordering</p>
                  {errors.order && <p className="mt-1 text-red-400 text-sm">{errors.order}</p>}
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    disabled={isSubmitting || loading}
                  />
                  <p className="text-xs text-gray-500 mt-1">Estimated duration for completion</p>
                  {errors.duration && <p className="mt-1 text-red-400 text-sm">{errors.duration}</p>}
                </div>
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <p className="text-xs text-gray-500 mt-1">Allow free preview access</p>
                </div>
              </div>
            </div>
            ...
            {/* File Upload Section */}
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-white">Content Files</h3>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Main File */}
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">
                    Main Content File {!isEditing && <span className="text-red-400">*</span>}
                    {isEditing && <span className="text-gray-400 text-sm ml-2">(leave empty to keep existing)</span>}
                  </label>
                  <div 
                  ...
                  >
                    {formData.mainFile ? (
                      <div className="flex items-center gap-3 justify-center">
                        ...
                        <button
                          type="button"
                          onClick={(e) => { e.stopPropagation(); removeMainFile(); }}
                      ...
                      <div className="text-gray-400">
                        ...
                        <p className="text-sm font-medium">
                          ...
                          {isEditing && ' (optional - will replace existing file)'}
                        </p>
                        <p className="text-xs mt-1">Max 500MB • Supported: MP4, WebM, OGG, PDF, DOC, DOCX</p>
                      </div>
                    )}
                  </div>
                  <input
                    ...
                    disabled={isSubmitting || loading}
                  />
                  {errors.mainFile && <p className="mt-1 text-red-400 text-sm">{errors.mainFile}</p>}
                </div>

                {/* Attachments */}
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">
                    Additional Files <span className="text-gray-500">(Optional)</span>
                  </label>
                  <div 
                    className="border-2 border-dashed border-gray-600 rounded-lg p-6 text-center hover:border-gray-500 transition-colors cursor-pointer bg-gray-800/50"
                  ...
                  >
                    ...
                    <p className="text-sm font-medium text-gray-400">Click to upload attachments</p>
                    <p className="text-xs text-gray-500 mt-1">Max 10 files • PDF, DOC, DOCX, JPG, PNG</p>
                  </div>
                  <input
                  ...
                  {errors.attachments && <p className="mt-1 text-red-400 text-sm">{errors.attachments}</p>}
                </div>
              </div>
            </div>
          </form>
