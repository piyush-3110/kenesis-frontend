...
import { FaInstagram, FaLinkedin, FaTelegram, FaThreads, FaXTwitter } from "react-icons/fa6";
            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                <div className="flex flex-col lg:flex-row justify-between items-start gap-12 lg:gap-8">
                    ...
                    <div className="flex flex-col items-start gap-6 max-w-md">
                        ...
                        >
                            Kenesis is the only platform on the market specialized in sales and conversion of physical
                            and digital products in the Web3 space.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col items-center lg:items-end gap-8 w-full lg:w-auto">
                        ...
                        <div className="flex flex-col items-center lg:items-end gap-6">
                            ...
                            <h3 className="text-white text-xl font-semibold font-inter">Download our app</h3>
                ...
                <div className="flex flex-col lg:flex-row justify-between items-center mt-6 gap-6">
                    ...
                    <div className="flex gap-6 text-white text-base font-inter opacity-80">
                        <a
                            href="https://kenesis.io/terms-and-conditions"
                            target="_blank"
                            rel="noopener noreferrer"
                        ...
                        <span>|</span>
                        <a
                            href="https://kenesis.io/privacy-policy"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="hover:text-blue-300 transition-colors"
                        >
