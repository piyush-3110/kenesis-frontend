    ...
    <section className="relative min-h-[90vh] flex items-center justify-center px-4 py-12 overflow-hidden">
      ...
      <div className="relative z-10 text-center  mx-auto">
        <h1 className="font-poppins text-white mb-8">
          <div className="text-[48px] md:text-[64px] lg:text-[72px] font-semibold leading-tight mb-2">
            {title.boldWord1 ? (
              <>
          ...
          <div className="text-[48px] md:text-[64px] lg:text-[72px] font-semibold leading-tight">
            {title.boldWord2 ? (
              <>
