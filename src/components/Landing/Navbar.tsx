...
function AuthSection() {
    ...
    const avatarLetter = (user?.username || user?.email || user?.walletAddress || "U").charAt(0).toUpperCase();
                                ...
                                <div className="py-1">
                                    ...
                                    >
                                        ...
                                        <span className="font-medium text-lg">
                                            {isLoggingOut || logout.isPending ? "Logging out..." : "Logout"}
                                        </span>
                                    </button>
                                </div>
                            </div>
                ...
                <div className="flex items-center space-x-3 md:space-x-8">
                    ...
                    <div className="md:hidden flex items-center gap-2">
                        <Sheet>
                            ...
                            <SheetContent side="bottom" className="p-0 pb-8 border-t border-white/10">
                                ...
                                <div className="px-6 flex flex-col gap-4">
                                    ...
                                    <p className="text-[11px] text-center text-gray-500 mt-2">Explore. Create. Earn.</p>
                                </div>
                            </SheetContent>
                        </Sheet>
                    </div>
