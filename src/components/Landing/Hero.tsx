    ...
    <section className="relative flex flex-col items-center text-center px-4 pt-28 sm:pt-32 md:pt-40 max-w-screen-xl mx-auto overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/4 w-[1000px] h-[600px] pointer-events-none">
        <div 
          ...
          style={{
            background: 'radial-gradient(circle, rgba(6,128,255,0.8) 0%, rgba(2,46,210,0.5) 40%, rgba(6,128,255,0.2) 70%, transparent 90%)',
            maskImage: 'linear-gradient(to bottom, rgba(0,0,0,1) 0%, rgba(0,0,0,0.7) 60%, rgba(0,0,0,0.3) 80%, transparent 100%)',
            WebkitMaskImage: 'linear-gradient(to bottom, rgba(0,0,0,1) 0%, rgba(0,0,0,0.7) 60%, rgba(0,0,0,0.3) 80%, transparent 100%)'
          }}
        />
      </div>
